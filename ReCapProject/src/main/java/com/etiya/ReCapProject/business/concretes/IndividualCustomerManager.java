...
public class IndividualCustomerManager implements IndividualCustomerService {
	...
	public DataResult<List<IndividualCustomer>> getAll() {
		return new SuccessDataResult<List<IndividualCustomer>>(this.individualCustomerDao.findAll(), Messages.CustomersListed);
	}

	@Override
	public DataResult<IndividualCustomer> getById(int individualCustomerId) {
		return new SuccessDataResult<IndividualCustomer>(this.individualCustomerDao.getById(individualCustomerId), Messages.CustomerListed);
	}

	@Override
	public Result add(CreateIndividualCustomerRequest createIndividualCustomerRequest) {
		
		ApplicationUser applicationUser = this.userService.getById(createIndividualCustomerRequest.getUserId()).getData();
	...
	public Result update(UpdateIndividualCustomerRequest updateIndividualCustomerRequest) {
		...
		ApplicationUser applicationUser = this.userService.getById(updateIndividualCustomerRequest.getUserId()).getData();
