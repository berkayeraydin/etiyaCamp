...
import kodlama.io.hrms2.dataAccess.abstracts.JobPositionDao;
...
public class JobPositionManager implements JobPositionService {
	...
	public DataResult<List<JobPosition>> getAll() {
		...
		return new SuccesDataResult<List<JobPosition>>(this.jobPositionDao.findAll(), "Positions Basariyla Listelendi.");
	}
